...
export function PageHero({ eyebrow, title, description }: { readonly eyebrow?: string; readonly title: string; readonly description: string }) {
  return (
    <section className="mb-14 grid gap-10 border-b border-[#e7e5dc] pb-12 lg:min-h-[420px] lg:grid-cols-[minmax(0,1.08fr)_minmax(360px,0.92fr)] lg:items-end">
      ...
      <div className="mesh-card hidden min-h-[310px] p-5 lg:block" style={heroMeshStyle}>
