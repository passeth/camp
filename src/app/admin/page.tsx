  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-5 md:grid-cols-3">
        <Link href="/admin/content" className="rounded-lg border border-[#e7e5dc] bg-white p-6 transition hover:-translate-y-1"><h2 className="text-2xl font-semibold tracking-[-0.035em] text-[#171717]">게시글 관리</h2><p className="mt-3 text-sm leading-6 text-[#5b6270]">게시글 수정, 삭제, 연결 관계 메타데이터를 관리합니다.</p></Link>
